...
interface CreateCustomLabTestModalProps {
  visible: boolean;
  onClose: () => void;
  onSave: (newItem: Partial<LabCatalogItem>) => void;
}

export const CreateCustomLabTestModal: React.FC<CreateCustomLabTestModalProps> = ({
  visible,
  onClose,
  onSave,
}) => {
        ...
        <KeyboardAvoidingView
          ...
          <View style={styles.header}>
            <View style={{ flex: 1, alignItems: 'center' }}>
              <Text style={styles.headerTitle}>Create Custom Lab Test</Text>
          ...
          <View style={styles.footerRow}>
            ...
            <TouchableOpacity
              ...
              activeOpacity={0.8}
              onPress={handleSave}>
              <Text style={styles.saveBtnText}>Save Custom Test</Text>
            </TouchableOpacity>
          </View>
        </KeyboardAvoidingView>
      </View>
