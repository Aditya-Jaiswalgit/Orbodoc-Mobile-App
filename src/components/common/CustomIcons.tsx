...
export const CalendarIcon: React.FC<IconProps> = ({ color = '#0d9488', size = 22 }) => {
  ...
  return (
    <Image
      source={{ uri: getIconPngUri('calendar', color) }}
...
export const StethoscopeIcon: React.FC<IconProps> = ({ color = '#ffffff', size = 22 }) => {
  const webSvg = renderWebSvg(size, color, [
    { tag: 'path', props: { d: 'M4.8 2.3A.3.3 0 1 0 5 2H4a2 2 0 0 0-2 2v5a6 6 0 0 0 6 6v0a6 6 0 0 0 6-6V4a2 2 0 0 0-2-2h-1a.2.2 0 1 0 .3.3' } },
    { tag: 'path', props: { d: 'M8 15v1a6 6 0 0 0 6 6v0a6 6 0 0 0 6-6v-4' } },
...
export const ActivityPulseIcon: React.FC<IconProps> = ({ color = '#10b981', size = 20 }) => {
  const webSvg = renderWebSvg(size, color, [
  ...
  return (
    <Image
      source={{ uri: getIconPngUri('activity', color) }}
      style={{ width: size, height: size }}
      resizeMode="contain"
    />
  );
...
export const ReceiptBillIcon: React.FC<IconProps> = ({ color = '#ffffff', size = 26 }) => {
  const webSvg = renderWebSvg(size, color, [
    { tag: 'path', props: { d: 'M15 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7Z' } },
    { tag: 'path', props: { d: 'M14 2v4a2 2 0 0 0 2 2h4' } },
    { tag: 'path', props: { d: 'M8 13h8' } },
    { tag: 'path', props: { d: 'M8 17h8' } },
    { tag: 'path', props: { d: 'M8 9h3' } },
  ]);
  if (webSvg) return webSvg;
  ...
  return (
    <View
      style={{
        ...
        paddingVertical: h * 0.18,
        justifyContent: 'space-between',
      }}>
      <View style={{ width: '100%', height: 2, backgroundColor: color, borderRadius: 1 }} />
      <View style={{ width: '100%', height: 2, backgroundColor: color, borderRadius: 1 }} />
      <View style={{ width: '65%', height: 2, backgroundColor: color, borderRadius: 1 }} />
      <View style={{ width: '100%', height: 2, backgroundColor: color, borderRadius: 1 }} />
    </View>
  );
};
...
export const DrawerCalendarIcon: React.FC<IconProps> = ({ color = '#2dd4bf', size = 20 }) => {
  const webSvg = renderWebSvg(size, color, [
    { tag: 'path', props: { d: 'M8 2v4' } },
    { tag: 'path', props: { d: 'M16 2v4' } },
    { tag: 'rect', props: { width: '18', height: '18', x: '3', y: '4', rx: '2' } },
