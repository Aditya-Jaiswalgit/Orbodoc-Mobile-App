  ...
  const handleOpenAction = async (
    ...
    if (actionType === 'details') {
      ...
      if (list && list.length > 0) {
        handleSelectPrescription(list[0]);
      } else {
        ...
        <View style={styles.sheetOverlay}>
          ...
          <View style={styles.pickerBottomSheetContainer}>
            ...
            <TouchableOpacity
              ...
              onPress={() => {
                setShowActionMenuModal(false);
                if (activeDisplayPatient) handleToggleStatus(activeDisplayPatient);
              }}>
              <Text style={{ fontSize: 14 }}>{activeDisplayPatient?.is_active !== false ? '🔴' : '🟢'}</Text>
              <Text style={styles.actionOptionText}>
                {activeDisplayPatient?.is_active !== false ? 'Mark as Inactive' : 'Mark as Active'}
              </Text>
            </TouchableOpacity>
              ...
              <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.sheetContentScroll}>
                <View style={styles.cardsGridTwoCol}>
                  ...
                  <View style={[styles.detailCard, styles.contactCardHighlight]}>
                    ...
                    <View style={styles.detailDataRow}>
                      ...
                      <Text style={styles.dataValBold}>{activeDisplayPatient?.email || `${(activeDisplayPatient?.full_name || 'patient').toLowerCase().replace(/\s+/g, '')}@gmail.com`}</Text>
                    </View>
                    <View style={styles.detailDataRow}>
                      <Text style={styles.dataLabelIcon}>📍 Address</Text>
                      <Text style={styles.dataValBold}>{activeDisplayPatient?.address || (activeDisplayPatient as any)?.address_line1 || 'palasiya'}</Text>
                    </View>
                    <View style={styles.detailDataRow}>
                      <Text style={styles.dataLabelIcon}>📍 City</Text>
                      <Text style={styles.dataValBold}>{(activeDisplayPatient as any)?.city || 'Anantapur'}</Text>
                    </View>
                    <View style={styles.detailDataRow}>
                      <Text style={styles.dataLabelIcon}>📍 State</Text>
                      <Text style={styles.dataValBold}>{(activeDisplayPatient as any)?.state || 'Andhra Pradesh'}</Text>
                    </View>
                  </View>
                  ...
                  <View style={styles.detailCard}>
                    ...
                    <View style={styles.detailDataRow}>
                      ...
                      <Text style={styles.dataValBold}>
                        {formatDateShort(activeDisplayPatient?.registered_at || (activeDisplayPatient as any)?.created_at || '7/30/2026')}
                      </Text>
                    </View>
                    <View style={styles.detailDataRow}>
                      <Text style={styles.dataLabel}>Last Visit</Text>
                      <Text style={styles.dataValBold}>
                        {formatDateShort((activeDisplayPatient as any)?.last_visit || activeDisplayPatient?.registered_at || (activeDisplayPatient as any)?.created_at || '9/5/2026')}
                      </Text>
                    </View>
                    <View style={styles.detailDataRow}>
                      <Text style={styles.dataLabel}>Total Visits</Text>
                      <Text style={styles.dataValBold}>
                        {(activeDisplayPatient as any)?.total_visits ?? (activeDisplayPatient as any)?.billingSummary?.total_visits ?? 9}
                      </Text>
                    </View>
                  </View>
                  ...
                  <View style={styles.detailCard}>
                    ...
                    <View style={styles.detailDataRow}>
                      ...
                      <Text style={styles.dataValBold}>{activeDisplayPatient?.emergency_contact || '9568956985'}</Text>
                    </View>
                  </View>
                </View>
                ...
                <View style={[styles.detailCard, { marginTop: 12 }]}>
                  ...
                  <View style={styles.billingSummaryRowGrid}>
                    <View style={styles.billingItemCol}>
                      <Text style={styles.dataLabel}>Treatment Bill</Text>
                      <Text style={styles.dataValBold}>
                        ₹{Number((activeDisplayPatient as any)?.treatment_total_amount ?? (activeDisplayPatient as any)?.billingSummary?.treatment_total_amount ?? 799).toFixed(2)}
                      </Text>
                    </View>
                    <View style={styles.billingItemCol}>
                      <Text style={styles.dataLabel}>Grand Total</Text>
                      <Text style={[styles.dataValBold, { color: '#0d9488', fontSize: 15 }]}>
                        ₹{Number((activeDisplayPatient as any)?.grand_total_amount ?? (activeDisplayPatient as any)?.billingSummary?.grand_total_amount ?? 799).toFixed(2)}
                      </Text>
                    </View>
                  </View>
                </View>
        ...
        <View style={styles.sheetOverlay}>
          ...
          <View style={styles.bottomSheetContainer}>
            ...
            <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.sheetContentScroll}>
              ...
              <View style={styles.formRowTwo}>
                <View style={[styles.formGroup, { flex: 1 }]}>
                  <Text style={styles.labelReq}>Name *</Text>
                  <TextInput
                    style={styles.formInput}
                    value={editName}
                ...
                <View style={[styles.formGroup, { flex: 1 }]}>
                  <Text style={styles.labelReq}>Date of Birth *</Text>
                  <TextInput
                    style={styles.formInput}
                    value={editDob}
              ...
              <View style={styles.formRowTwo}>
                <View style={[styles.formGroup, { flex: 1 }]}>
                  <Text style={styles.labelReq}>Phone *</Text>
                  <TextInput
                    style={styles.formInput}
                    value={editPhone}
                ...
                <View style={[styles.formGroup, { flex: 1 }]}>
                  <Text style={styles.labelReq}>Email</Text>
                  <TextInput
                    style={styles.formInput}
                    value={editEmail}
              ...
              <View style={styles.formRowTwo}>
                <View style={[styles.formGroup, { flex: 1 }]}>
                  <Text style={styles.labelReq}>City *</Text>
                  <TextInput
                    style={styles.formInput}
                    value={editCity}
                ...
                <View style={[styles.formGroup, { flex: 1 }]}>
                  <Text style={styles.labelReq}>State *</Text>
                  <TextInput
                    style={styles.formInput}
                    value={editState}
              ...
              <View style={styles.formRowTwo}>
                <View style={[styles.formGroup, { flex: 1 }]}>
                  <Text style={styles.labelReq}>Contact Name</Text>
                  <TextInput
                    style={styles.formInput}
                ...
                <View style={[styles.formGroup, { flex: 1 }]}>
                  <Text style={styles.labelReq}>Relation</Text>
                  <TextInput
                    style={styles.formInput}
              ...
              <View style={styles.formGroup}>
                <Text style={styles.labelReq}>Emergency Phone</Text>
                <TextInput
                  style={styles.formInput}
            ...
            <View style={styles.modalFooterRow}>
              ...
              <TouchableOpacity style={styles.saveTealBtn} onPress={handleSaveEditPatient}>
                <Text style={styles.saveTealBtnText}>Update Patient</Text>
              </TouchableOpacity>
            </View>
          </View>
        </View>
...
const styles = StyleSheet.create({
  ...
  avatarBigCircle: { width: 44, height: 44, borderRadius: 22, backgroundColor: '#ccebe6', alignItems: 'center', justifyContent: 'center' },
  avatarBigLetter: { color: '#0f766e', fontSize: 20, fontWeight: '800' },
  ...
  prescFooterRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', backgroundColor: '#071624', paddingHorizontal: 16, paddingVertical: 12, marginHorizontal: -18, marginBottom: -18, marginTop: 12, borderBottomLeftRadius: 24, borderBottomRightRadius: 24 },
  ...
  consultCardFull: { backgroundColor: '#ffffff', borderRadius: 16, padding: 14, borderWidth: 1, borderColor: '#e2e8f0', gap: 10, shadowColor: '#000000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.04, shadowRadius: 4, elevation: 2 },
